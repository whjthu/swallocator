...
# ./test_trace.out trace memtest_trace/$1.memlog 0
# ./test_trace.out trace memtest_trace/$1.memlog 1
# ./test_trace.out trace memtest_trace/$1.memlog 2
# ./test_trace.out trace memtest_trace/$1.memlog 3
